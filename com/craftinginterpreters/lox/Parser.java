...
class Parser {
    ...
    private Stmt ifStatement() {
        ...
        consume(RIGHT_PAREN, "Expected ')' after if cindition.");
        ...
        if (!check(RIGHT_PAREN)) {
            do {
                if (parameters.size() >= 255) {
                    error(peek(), "Can't hace more than 255 parameters");
                }
                parameters.add(
    ...
    private List<Stmt> block() {
        ...
        consume(RIGHT_BRACE, "Expct '}' after block.");
        return statements;
    }
    ...
    private Expr finishCall(Expr callee) {
        ...
        Token paren = consume(RIGHT_PAREN, "Expected ')' after expression.");
